...
/mob/new_player/proc/show_new_information()
	var/dat = {"<h2>Untitled 40k Bear Station</h2>
Hello! It appears you are new here! Thanks for joining Untitled 40k Bear Station. Here is some important information to get you started!
<h3>Discord Link</h3>
<font size='4'><a href=\"https://discord.gg/D779aMU8kY\">Discord</a></font>
<h3>Wiki Link</h3>
<font size='4'><a href=\"http://is12wiki.xyz/index.php/Main_Page\">Wiki</a></font>
<h3>Server Summary</h3>
Untitled 40k Bear Station is a Warhammer 40k SS13 server running a modified version of the IS12 codebase. Set on an internment planet for heretics and criminals whose crimes were not enough to face execution. You serve under a Rogue Trader who goes about ensuring Imperial expansion and growing his own riches. North of the village is an Imperial Administratum building where Imperial citizens live and minor research is done with the resources of this planet. Heavy role-play is expected.
<h3>Some Notes</h3>
