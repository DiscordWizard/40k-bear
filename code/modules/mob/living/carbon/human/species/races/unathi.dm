/datum/species/unathi
	...
	icon_template = 'icons/mob/human_races/unathi/template_tall.dmi'
	icobase = 'icons/mob/human_races/unathi/body.dmi'
	deform = 'icons/mob/human_races/unathi/deformed_body.dmi'
